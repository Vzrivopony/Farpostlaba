...
if __name__ == '__main__':
    ...
    advanced_python_teacher = Teacher('Aleksandra', 'Borisovna')

    lazy_student = Student('Sasha', 'Sokol')
    good_student = Student('Anna', 'Shpak')

    oop_hw = opp_teacher.create_homework('1234', 1)
    docs_hw = opp_teacher.create_homework('5124124', 5)
